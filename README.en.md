...
The [improvement record](docs/RSI.md) links the research and four rounds of actual outputs. The current skill is the approved baseline for further RSI. The local scheduled improvement task has been deleted; further iterations are started on demand.
